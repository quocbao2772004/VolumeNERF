...
def read_dicom(dcmdir: Union[Path, str], correct_zero: bool = True):
    ...
    if hasattr(ds, 'DistanceSourceToDetector'):
        dis = ds.DistanceSourceToDetector / 2
        ratio = ds.DistanceSourceToDetector / ds.DistanceSourceToPatient
    else:
        dis = 949 // 2
        ratio = 949 / 541

    return volume, spacing, dis, ratio
